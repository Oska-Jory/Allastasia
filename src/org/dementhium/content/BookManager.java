...
public class BookManager {
    ...
    public static boolean proceedBook(Player player, int stage) {
        ...
        switch (stage) {
            case 1:
                sendBook(player, -1, 2, false, true, "Dementhium Rule Book",
                        "<shad=6081134>Dementhium Rules</shad>", "",
                ...
                return true;
            case 2:
                sendBook(player, 1, 3, false, false, "Dementhium Rule Book",
                ...
                return true;
            case 3:
                sendBook(player, 2, -1, true, false, "Dementhium Rule Book",
                ...
                return false;
            case 4:
            	sendBook(player, 2, -1, true, true, "Dementhium Guide Book",
                        "",
                        "Fairy Ring Codes", "------------------------",
